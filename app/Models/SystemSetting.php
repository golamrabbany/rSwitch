...
class SystemSetting extends Model
{
    ...
    public static function seedDefaults(): void
    {
        $defaults = [
            ...
            ['key' => 'sip_pin_min_length', 'value' => '4', 'type' => 'integer', 'group' => 'sip', 'sort_order' => 5, 'label' => 'SIP PIN Min Length', 'description' => 'Minimum length for SIP account username/PIN.'],
            ['key' => 'sip_pin_max_length', 'value' => '10', 'type' => 'integer', 'group' => 'sip', 'sort_order' => 6, 'label' => 'SIP PIN Max Length', 'description' => 'Maximum length for SIP account username/PIN.'],
