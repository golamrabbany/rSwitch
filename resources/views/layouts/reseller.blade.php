            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
                ...
                <nav class="flex-1 overflow-y-auto py-4 px-4 space-y-1">
                    <a href="{{ route('reseller.dashboard') }}"
                       class="{{ request()->routeIs('reseller.dashboard') ? 'nav-item-active' : 'nav-item-inactive' }}">
                    ...
                    <a href="{{ route('reseller.clients.index') }}"
                       class="{{ request()->routeIs('reseller.clients.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('reseller.sip-accounts.index') }}"
                       class="{{ request()->routeIs('reseller.sip-accounts.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('reseller.cdr.index') }}"
                       class="{{ request()->routeIs('reseller.cdr.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('reseller.transactions.index') }}"
                       class="{{ request()->routeIs('reseller.transactions.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('reseller.balance.create') }}"
                       class="{{ request()->routeIs('reseller.balance.*') ? 'nav-item-active' : 'nav-item-inactive' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="border-t border-white/10 p-4">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-sm font-semibold text-white">
                            {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-white truncate">{{ auth()->user()->name }}</p>
                            <p class="text-xs text-emerald-400 font-medium">${{ number_format(auth()->user()->balance, 2) }}</p>
                        </div>
                    </div>
                </div>
            </aside>
