<x-client-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('client.sip-accounts.edit', $sipAccount) }}" class="rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">Edit</a>
        </div>
    </x-slot>
    ...
    <div class="mt-6">
        <a href="{{ route('client.sip-accounts.index') }}" class="text-sm font-semibold text-gray-600 hover:text-gray-900">&larr; Back to SIP accounts</a>
    </div>
</x-client-layout>
