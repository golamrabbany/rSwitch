<x-client-layout>
    ...
    <div class="mb-6 bg-white shadow sm:rounded-lg p-4">
        <form method="GET" action="{{ route('client.transactions.index') }}">
            ...
            <div class="flex items-center gap-3 mt-4">
                ...
                <a href="{{ route('client.transactions.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Clear</a>
            </div>
        </form>
    </div>
    ...
    <div class="bg-white shadow sm:rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-sm text-gray-500">No transactions found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
