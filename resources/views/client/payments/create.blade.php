    ...
    <div class="max-w-lg">
        <div class="bg-white shadow sm:rounded-lg p-6 space-y-6">
            <div>
                ...
                <p class="mt-1 text-3xl font-bold text-gray-900">{{ format_currency(auth()->user()->balance) }}</p>
                <p class="text-sm text-gray-500">{{ currency_code() }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('client.payments.checkout') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Minimum {{ currency_symbol() }}5.00, maximum {{ currency_symbol() }}10,000.00</p>
