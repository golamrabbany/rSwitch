<x-admin-layout>
    <x-slot name="header">Edit Routing Rule: {{ $trunkRoute->prefix }}</x-slot>
    ...
    <div class="max-w-3xl" x-data="{
        ...
        <form method="POST" action="{{ route('admin.trunk-routes.update', $trunkRoute) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white shadow sm:rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="number" id="priority" name="priority" value="{{ old('priority', $trunkRoute->priority) }}" required min="1" max="100"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" id="weight" name="weight" value="{{ old('weight', $trunkRoute->weight) }}" required min="1" max="1000"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div x-show="timeBasedRouting" x-cloak class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="time" id="time_start" name="time_start" value="{{ old('time_start', $trunkRoute->time_start ? substr($trunkRoute->time_start, 0, 5) : '') }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="time" id="time_end" name="time_end" value="{{ old('time_end', $trunkRoute->time_end ? substr($trunkRoute->time_end, 0, 5) : '') }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
