<x-admin-layout>
    ...
    @php
        ...
        $selectedTrunk = $trunks->firstWhere('id', old('trunk_id', $selectedTrunkId));
    @endphp
    ...
    <form method="POST" action="{{ route('admin.trunk-routes.store') }}" x-data="{
        ...
        trunkId: '{{ old('trunk_id', $selectedTrunkId) }}',
        trunks: {{ $trunksJson }},
                        ...
                        <div x-show="mnpEnabled" x-cloak class="space-y-4 mt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mnp_prefix" name="mnp_prefix" value="{{ old('mnp_prefix', '71') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="mnp_insert_position" name="mnp_insert_position" value="{{ old('mnp_insert_position', '3') }}"
