    ...
    <div class="page-header-row">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="page-subtitle">Day-by-day call volume trends</p>
            </div>
        </div>
        <div class="page-actions">
            <a href="{{ route('admin.operational-reports.daily.export', request()->query()) }}" class="btn-action-secondary">
        ...
        <form method="GET" class="space-y-3">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden text-xs flex-shrink-0">
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_type'), [])) }}" class="px-3 py-2 font-medium {{ !request('call_type') ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">All</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_type'), ['call_type' => 'regular'])) }}" class="px-3 py-2 font-medium border-l {{ request('call_type') === 'regular' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">Regular</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_type'), ['call_type' => 'broadcast'])) }}" class="px-3 py-2 font-medium border-l {{ request('call_type') === 'broadcast' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">Broadcast</a>
                </div>
                <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden text-xs flex-shrink-0">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden text-xs flex-shrink-0">
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_flow'), [])) }}" class="px-2.5 py-2 font-medium {{ !request('call_flow') ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">All</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_flow'), ['call_flow' => 'trunk_to_sip'])) }}" class="px-2.5 py-2 font-medium border-l {{ request('call_flow') === 'trunk_to_sip' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">Inbound</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_flow'), ['call_flow' => 'sip_to_trunk'])) }}" class="px-2.5 py-2 font-medium border-l {{ request('call_flow') === 'sip_to_trunk' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">Outbound</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_flow'), ['call_flow' => 'sip_to_sip'])) }}" class="px-2.5 py-2 font-medium border-l {{ request('call_flow') === 'sip_to_sip' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">P2P</a>
                    <a href="{{ route('admin.operational-reports.daily', array_merge(request()->except('call_flow'), ['call_flow' => 'trunk_to_trunk'])) }}" class="px-2.5 py-2 font-medium border-l {{ request('call_flow') === 'trunk_to_trunk' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50' }}">Transit</a>
                </div>
                {{-- Reseller --}}
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden mb-6">
            <div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
                <span class="text-sm text-gray-600">
                    ...
                    ({{ $dateFrom->format('M d, Y') }} &mdash; {{ $dateTo->format('M d, Y') }})
                </span>
            </div>
                    ...
                    <tbody>
                        @foreach($rows as $index => $row)
                            <tr class="{{ $loop->even ? 'bg-gray-50/50' : 'bg-white' }} hover:bg-indigo-50/50 transition-all border-b border-gray-100 group">
                                ...
                                <td class="px-3 py-2 font-medium text-gray-900">{{ \Carbon\Carbon::parse($row->date)->format('M d, Y') }}</td>
