<x-admin-layout>
    ...
    <div class="mb-4 grid grid-cols-3 sm:grid-cols-6 gap-2">
        ...
        <div class="flex items-center gap-1.5 px-2 py-1.5 bg-white rounded-md border border-gray-200 min-w-0">
            ...
            <div class="flex items-baseline gap-1.5 min-w-0">
                <p class="text-base font-semibold text-red-600 leading-none tabular-nums">{{ number_format($totalCalls - $answeredCalls) }}</p>
        ...
        <div class="flex items-center gap-1.5 px-2 py-1.5 bg-white rounded-md border border-gray-200 min-w-0">
            ...
            <div class="flex items-baseline gap-1.5 min-w-0">
                <p class="text-base font-semibold text-blue-600 leading-none tabular-nums">{{ $acdMin }}:{{ str_pad($acdSec, 2, '0', STR_PAD_LEFT) }}</p>
    ...
    @else
        ...
        <div class="bg-white rounded-xl border border-gray-200 py-16">
            <div class="text-center">
                ...
                <h3 class="text-base font-semibold text-gray-900 mb-1">No Outbound Calls Found</h3>
