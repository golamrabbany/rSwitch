<x-admin-layout>
    ...
    <div class="mb-5" style="display:grid; grid-template-columns: repeat(6, 1fr); gap:1rem;">
        <div class="stat-card">
            ...
            <div class="stat-content"><p class="stat-value">{{ number_format($totalCalls) }}</p><p class="stat-label">Total Calls</p></div>
        </div>
        <div class="stat-card">
            ...
            <div class="stat-content"><p class="stat-value text-emerald-600">{{ number_format($answeredCalls) }}</p><p class="stat-label">Answered</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon bg-red-100"><svg class="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
            <div class="stat-content"><p class="stat-value text-red-500">{{ number_format($failedCalls) }}</p><p class="stat-label">Failed</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon {{ $asr >= 50 ? 'bg-emerald-100' : 'bg-amber-100' }}"><svg class="w-6 h-6 {{ $asr >= 50 ? 'text-emerald-600' : 'text-amber-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg></div>
            <div class="stat-content"><p class="stat-value {{ $asr >= 50 ? 'text-emerald-600' : 'text-amber-600' }}">{{ $asr }}%</p><p class="stat-label">ASR</p></div>
        </div>
        <div class="stat-card">
            ...
            <div class="stat-content"><p class="stat-value tabular-nums">{{ $acdMin }}:{{ sprintf('%02d', $acdSec) }}</p><p class="stat-label">ACD</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon bg-indigo-100"><svg class="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
            <div class="stat-content"><p class="stat-value">{{ number_format($totalMinutes, 0) }}</p><p class="stat-label">Minutes</p></div>
        </div>
    </div>
