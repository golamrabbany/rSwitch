<x-admin-layout>
    ...
    <div class="mb-4 grid grid-cols-3 sm:grid-cols-6 gap-2">
        ...
        <div class="flex items-center gap-2 px-3 py-2 bg-white rounded-lg border border-gray-200">
            ...
            <div class="flex items-baseline gap-1.5 min-w-0">
                <p class="text-lg font-semibold text-red-500 leading-none tabular-nums">{{ number_format($failedCalls) }}</p>
        ...
        <div class="flex items-center gap-2 px-3 py-2 bg-white rounded-lg border border-gray-200">
            ...
            <div class="flex items-baseline gap-1.5 min-w-0">
                <p class="text-lg font-semibold text-gray-900 leading-none tabular-nums">{{ $acdMin }}:{{ sprintf('%02d', $acdSec) }}</p>
