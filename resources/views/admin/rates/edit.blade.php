                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="form-group">
                                ...
                                <select id="rate_type" name="rate_type" class="form-input">
                                    <option value="regular" {{ old('rate_type', $rate->rate_type ?? 'regular') === 'regular' ? 'selected' : '' }}>Regular</option>
                                    <option value="broadcast" {{ old('rate_type', $rate->rate_type ?? 'regular') === 'broadcast' ? 'selected' : '' }}>Broadcast</option>
                                </select>
