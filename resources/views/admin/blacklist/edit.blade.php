    ...
    <div class="max-w-2xl">
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 class="text-base font-semibold text-gray-900">Edit Blacklist: {{ $blacklist->prefix }}</h3>
            </div>

            <form method="POST" action="{{ route('admin.blacklist.update', $blacklist) }}" class="p-6 space-y-6" x-data="{ appliesTo: '{{ old('applies_to', $blacklist->applies_to) }}' }">
                @csrf @method('PUT')
