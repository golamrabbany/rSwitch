            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        ...
                        @if(auth()->user()->isSuperAdmin())
                        <div class="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4" x-data="{ autoBal: {{ old('auto_recharge_enabled') ? 'true' : 'false' }} }">
                            <div class="flex flex-wrap items-end justify-between gap-4">
                                ...
                                <div x-show="autoBal" x-transition style="{{ old('auto_recharge_enabled') ? '' : 'display:none' }}">
