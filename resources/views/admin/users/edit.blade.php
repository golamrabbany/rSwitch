                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                <label class="inline-flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="auto_recharge_enabled" value="1" {{ old('auto_recharge_enabled', $user->auto_recharge_enabled) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600">
