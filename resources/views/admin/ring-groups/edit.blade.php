<x-admin-layout>
    <x-slot name="header">Edit Ring Group: {{ $ringGroup->name }}</x-slot>

    <div class="max-w-3xl" x-data="ringGroupForm()">
        <form method="POST" action="{{ route('admin.ring-groups.update', $ringGroup) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white shadow sm:rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $ringGroup->name) }}" required
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="2"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $ringGroup->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" id="ring_timeout" name="ring_timeout" value="{{ old('ring_timeout', $ringGroup->ring_timeout) }}" required
                               min="5" max="300"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div class="flex items-center justify-end gap-x-3">
                <a href="{{ route('admin.ring-groups.show', $ringGroup) }}" class="text-sm font-semibold text-gray-900">Cancel</a>
