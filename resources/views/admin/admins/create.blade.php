<x-admin-layout>
    <x-slot name="header">Add Regular Admin</x-slot>
    ...
    <div class="page-header-row">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="page-title">Add Regular Admin</h2>
                <p class="page-subtitle">Create a new admin with assigned reseller access</p>
            </div>
        </div>
        <div class="page-actions">
            <a href="{{ route('admin.admins.index') }}" class="btn-action-secondary">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-card-body">
                        <div class="flex items-center gap-3 p-3 bg-indigo-50 rounded-lg mb-4">
                            ...
                            <div>
                                <p class="text-sm font-medium text-indigo-800">Regular Admin Creation</p>
                                <p class="text-xs text-indigo-600">Account requires reseller assignment</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex items-center gap-2 text-gray-600">
                                ...
                                <span>Access to assigned resellers only</span>
                            </div>
                            <div class="flex items-center gap-2 text-gray-600">
                                <svg class="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-card-body space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Can manage assigned resellers and their clients. Full CRUD access within scope.</p>
                        </div>
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <span class="badge badge-gray">Restricted</span>
                            </div>
                            <p class="text-xs text-gray-500">Cannot access system settings, trunks, rates, or unassigned accounts.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="detail-card-body">
                        <ul class="text-xs text-gray-600 space-y-2">
                            ...
                            <li class="flex items-start gap-2">
                                ...
                                <span>Admin can manage users within assigned scope</span>
                            </li>
                        </ul>
                    </div>
                </div>
