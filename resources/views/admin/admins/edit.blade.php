<x-admin-layout>
    <x-slot name="header">Edit Regular Admin</x-slot>
    ...
    <div class="page-header-row">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="page-title">Edit Regular Admin</h2>
                <p class="page-subtitle">Update account details for {{ $admin->name }}</p>
            </div>
        </div>
        <div class="page-actions flex items-center gap-3">
            <span class="badge {{ $admin->status === 'active' ? 'badge-success' : ($admin->status === 'suspended' ? 'badge-warning' : 'badge-danger') }}">
                {{ ucfirst($admin->status) }}
            </span>
            <a href="{{ route('admin.admins.show', $admin) }}" class="btn-action-secondary">
                    ...
                    <div class="form-card-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $admin->name) }}" required class="form-input" placeholder="Enter full name">
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>

                            <div class="form-group">
                                <label for="email" class="form-label">Email Address</label>
                                <input type="email" id="email" name="email" value="{{ old('email', $admin->email) }}" required class="form-input" placeholder="Enter email address">
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        <div class="form-group">
                            ...
                            <p class="form-hint">Admin will only see data from assigned resellers and their clients</p>
            ...
            <div class="space-y-6">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-card-body">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center">
                        ...
                        <div class="space-y-3 text-sm border-t border-gray-100 pt-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-mono text-gray-900">#{{ $admin->id }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">2FA</span>
                                <span class="badge {{ $admin->two_factor_secret ? 'badge-success' : 'badge-gray' }}">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-card-body space-y-2">
                        <a href="{{ route('admin.admins.show', $admin) }}" class="quick-action-link">
                        ...
                        <a href="{{ route('admin.audit-logs.index', ['user_id' => $admin->id]) }}" class="quick-action-link">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
