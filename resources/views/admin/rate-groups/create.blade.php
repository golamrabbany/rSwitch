        ...
        <div class="bg-white shadow sm:rounded-lg p-6">
            <form method="POST" action="{{ route('admin.rate-groups.store') }}" x-data="{ type: '{{ old('type', 'admin') }}' }">
                ...
                <div class="space-y-6">
                    ...
                    <template x-if="type === 'reseller'">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Reseller rate groups inherit from an admin rate group.</p>
                ...
                <div class="mt-6 flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.rate-groups.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
                </div>
            </form>
        </div>
    </div>
