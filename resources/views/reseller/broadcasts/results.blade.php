<x-reseller-layout>
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    @if($broadcast->user)
                        ...
                        <span class="text-sm font-medium text-gray-900">{{ $broadcast->user->name }}</span>
                    @endif
                </div>
            </div>
        </div>
        <div class="page-actions">
            <a href="{{ route('reseller.broadcasts.export-results', $broadcast) }}" class="btn-action-secondary">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-lg bg-emerald-100 flex items-center justify-center">
                                                <span class="text-sm font-bold text-emerald-600">{{ $option['digit'] }}</span>
                                            </div>
                                            <span class="text-sm text-gray-700">{{ $option['label'] }}</span>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <div class="w-32 bg-gray-200 rounded-full h-2">
                                                <div class="bg-emerald-500 h-2 rounded-full" style="width: {{ $option['percentage'] }}%"></div>
                                            </div>
    ...
    @if($broadcast->type === 'survey' && !empty($surveyBreakdown))
        ...
        <script>
            var chartColors = ['#10b981', '#6366f1', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4', '#ec4899', '#f97316', '#14b8a6'];
            @if($broadcast->isMultiQuestion())
                @foreach($surveyBreakdown as $qIndex => $question)
