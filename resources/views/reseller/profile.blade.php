<x-reseller-layout>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div class="flex items-center gap-5">
            <div class="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-500 flex items-center justify-center flex-shrink-0">
            ...
            <div class="text-right flex-shrink-0">
                ...
                <p class="text-2xl font-bold text-emerald-600">{{ format_currency(auth()->user()->balance) }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="detail-card lg:col-span-2">
            ...
            <div class="p-6">
                ...
                @endif
                <form method="POST" action="{{ route('reseller.profile.password') }}" class="space-y-5">
                    @csrf
                    @method('PUT')
                    <div>
