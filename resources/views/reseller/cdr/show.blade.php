<x-reseller-layout>
    ...
    <div class="space-y-6">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <div class="px-4 py-4 border-b border-gray-200">
                    <h3 class="text-base font-semibold text-gray-900">Routing</h3>
                </div>
                <dl class="divide-y divide-gray-200">
                    <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                        ...
                        <dd class="mt-1 text-sm sm:col-span-2 sm:mt-0">
                            @if ($record->user)
                                @if($record->user_id === auth()->id())
                                    <span class="text-gray-900">You ({{ $record->user->name }})</span>
                                @else
                                    <a href="{{ route('reseller.clients.show', $record->user) }}" class="text-indigo-600 hover:text-indigo-500">{{ $record->user->name }}</a>
                                @endif
                    ...
                    <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                        ...
                        <dd class="mt-1 text-sm sm:col-span-2 sm:mt-0">
                            @if ($record->sipAccount)
                                <a href="{{ route('reseller.sip-accounts.show', $record->sipAccount) }}" class="text-indigo-600 hover:text-indigo-500 font-mono">{{ $record->sipAccount->username }}</a>
                            @else
                                <span class="text-gray-400">—</span>
                            @endif
                        </dd>
        ...
        <a href="{{ route('reseller.cdr.index') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
