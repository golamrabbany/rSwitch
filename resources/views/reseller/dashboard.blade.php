<x-reseller-layout>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 mt-1">Reseller Portal &mdash; {{ ucfirst(auth()->user()->billing_type) }} Account</p>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {{ auth()->user()->billing_type === 'prepaid' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700' }}">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-3">
                ...
                <a href="{{ route('reseller.clients.index') }}" class="text-xs text-indigo-600 hover:text-indigo-500 font-medium">View</a>
            </div>
            <p class="text-2xl font-bold text-gray-900">{{ number_format($entityCounts['clients'] ?? 0) }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <div class="flex items-center justify-between mb-3">
                ...
                <a href="{{ route('reseller.sip-accounts.index') }}" class="text-xs text-indigo-600 hover:text-indigo-500 font-medium">View</a>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
            ...
            <div class="flex items-center justify-between mt-2">
                ...
                @if($costChange >= 0)
                    <span class="inline-flex items-center text-xs text-emerald-600">+{{ abs($costChange) }}%</span>
                @else
                    <span class="inline-flex items-center text-xs text-red-600">-{{ abs($costChange) }}%</span>
                @endif
            </div>
        </div>
    </div>

    {{-- Daily Chart + Recent Calls --}}
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ auth()->user()->currency }}</span>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
                ...
                <div class="space-y-2">
                    <a href="{{ route('reseller.sip-accounts.create') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
                        ...
                        <span class="text-sm text-gray-700 group-hover:text-gray-900">New SIP Account</span>
                    </a>
                    <a href="{{ route('reseller.clients.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
                        ...
                        <span class="text-sm text-gray-700 group-hover:text-gray-900">Manage Clients</span>
                    </a>
                    <a href="{{ route('reseller.cdr.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors group">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="{{ route('reseller.cdr.index') }}" class="text-sm text-indigo-600 hover:text-indigo-500 font-medium">View All</a>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Client Cost</th>
                            <th class="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">My Cost</th>
                            <th class="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">Profit</th>
                        ...
                        @foreach ($recentCalls as $call)
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right tabular-nums font-medium text-gray-900">
                                    {{ $clientCost > 0 ? format_currency($clientCost) : '—' }}
                                </td>
                                <td class="px-4 py-3 text-right tabular-nums text-gray-600">
                                    {{ $resellerCost > 0 ? format_currency($resellerCost) : '—' }}
                                </td>
                                <td class="px-4 py-3 text-right tabular-nums font-medium {{ $profit > 0 ? 'text-emerald-600' : ($profit < 0 ? 'text-red-600' : 'text-gray-400') }}">
                                    {{ $clientCost > 0 ? format_currency($profit) : '—' }}
                                </td>
                                <td class="px-4 py-3 text-gray-500">{{ $call->user?->name ?? '—' }}</td>
                                <td class="px-4 py-3">
